...
from sklearn.cross_decomposition import PLSRegression ## Changed all PLSRegression object creation calls: positional arguments were changed to keyword arguments to fix a recurring 
